...
describe("GraphQL Parser", () => {
    ...
    test("parses simple GraphQL document", ({ parser }) => {
        const document = readFileSync(join(__dirname, "fixtures", "simple.graphql"), "utf-8");
    ...
    test("parses comprehensive GraphQL document", ({ parser }) => {
        ...
        const graphqlDocument = readFileSync(join(__dirname, "fixtures", "comprehensive.graphql"), "utf-8");
        // Parse the document
