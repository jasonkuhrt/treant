...
export type PatternRule = { type: 'PATTERN'; value: string };
export type PrecDynamicRule = { type: 'PREC_DYNAMIC'; content: Rule; value: number };
export type PrecLeftRule = { type: 'PREC_LEFT'; content: Rule; value: string | number };
export type PrecRightRule = { type: 'PREC_RIGHT'; content: Rule; value: string | number };
export type PrecRule = { type: 'PREC'; content: Rule; value: string | number };
 ...
 */
export type repeat1 = typeof repeat1;
 ...
 */
export type grammar = typeof grammar;
