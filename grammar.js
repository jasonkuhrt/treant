module.exports = grammar({
  ...
  rules: {
    ...
    executable_definition: ($) => choice($.operation_definition, $.fragment_definition),
    type_system_definition: ($) => choice($.schema_definition, $.type_definition, $.directive_definition),
    ...
    enum_values_definition: ($) => seq('{', repeat1($.enum_value_definition), '}'),
    enum_value_definition: ($) => seq(optional($.description), $.enum_value, optional($.directives)),
    ...
    arguments_definition: ($) => seq('(', repeat1($.input_value_definition), ')'),
    ...
    root_operation_type_definition: ($) => seq($.operation_type, ':', $.named_type),
    ...
    directive_location: ($) => choice($.executable_directive_location, $.type_system_directive_location),
